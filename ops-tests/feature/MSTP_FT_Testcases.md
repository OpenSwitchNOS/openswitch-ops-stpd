...
##References
* [MSTP CLI Document](http://openswitch.net/documents/user/mstp_cli)
* [MSTP User guide](http://openswitch.net/documents/user/mstp_user_guide)
* [MSTP Design](http://openswitch.net/documents/user/mstpd_design)

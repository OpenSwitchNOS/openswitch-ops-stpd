...
*/
struct switchd_stp_plugin_interface {
   const char* plugin_name;     /**< plugin plugin_name version */
   int major;                   /**< plugin major version */
   int minor;                   /**< plugin minor version */

/* Plugin Interfaces
 * The functions that are defined as extensions need to be added here as are
 * shown bellow.
 *
 * int (* stp_foo)(int param1, int param2);
 * int (* stp_bar)(int paramX);
 *
 */

...
#define MSTP_CIST_INST_VLAID(v)  ((v)>=MSTP_CIST && (v)<=MSTP_INST_MAX)
...
void mstp_cist_and_instance_vlan_add(const struct blk_params *br,
                                            struct mstp_instance *msti,
                                           const struct ovsrec_vlan *vlan_cfg);
void mstp_cist_and_instance_vlan_delete(const struct blk_params *br,
                                              struct mstp_instance *msti,
                                              struct mstp_instance_vlan *vlan);
void mstp_cist_and_instance_set_port_state(const struct blk_params *br,
                                                 struct mstp_instance *msti,
                                         struct mstp_instance_port *mstp_port);
void mstp_cist_and_instance_port_delete(const struct blk_params *br,
                                              struct mstp_instance *msti,
                                              struct mstp_instance_port *port);
void mstp_instance_add_del_vlans(const struct blk_params *br,
                                       struct mstp_instance *msti);

void mstp_instance_port_add(const struct blk_params *br,
                                 struct mstp_instance *msti,
                        const struct ovsrec_mstp_instance_port *inst_port_cfg);

void mstp_instance_add_del_ports(const struct blk_params *br,
                                       struct mstp_instance *msti);
void mstp_instance_create(const struct blk_params *br, int inst_id,
                              const struct ovsrec_mstp_instance *msti_cfg);
void mstp_instance_delete(const struct blk_params* br,
                              struct mstp_instance *msti);
void mstp_add_del_instances(const struct blk_params *br);
void mstp_cist_port_add(const struct blk_params *br,
                            struct mstp_instance *msti,
                 const struct ovsrec_mstp_common_instance_port *cist_port_cfg);
void mstp_cist_add_del_ports(const struct blk_params *br,
                                 struct mstp_instance *msti);
void mstp_cist_add_del_vlans(const struct blk_params *br,
                                  struct mstp_instance *msti);
void mstp_cist_create(const struct blk_params *br,
                      const struct ovsrec_mstp_common_instance *msti_cist_cfg);
void mstp_cist_add_update(const struct blk_params *br);
void mstp_cist_update_port_state(struct blk_params *br_blk_params,
                                      struct mstp_instance *msti);
void mstp_instance_update_port_state(struct blk_params *br_blk_params,
                                           struct mstp_instance *msti);

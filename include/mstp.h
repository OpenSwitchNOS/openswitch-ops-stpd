...
extern void mstpd_daemon_digest_unixctl_list(struct unixctl_conn *conn, int argc,
                   const char *argv[], void *aux OVS_UNUSED);
extern void mstpd_daemon_digest_data_dump(struct ds *ds, int argc, const char *argv[]);

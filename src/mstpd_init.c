 ...
 **PROC-**********************************************************************/
void
mstp_updateMstpCBPortMaps(PORT_MAP *pmap)
{
   MSTP_TREE_MSG_t *m;
   PORT_MAP         tmp_pmap;
...
mstp_clearBridgeGlobalData(void)
{
   ...
   mstp_Bridge.meshDynReconfig  = 0;
   mstp_Bridge.distTrunkReconfig= 0;
   ...
   /*------------------------------------------------------------------------
    * clear PVST Filtering.
    *------------------------------------------------------------------------*/
   clear_port_map(&mstp_Bridge.pvstFilterLports);
   ...
   /*------------------------------------------------------------------------
    * clear PVST Protection
    *------------------------------------------------------------------------*/
   clear_port_map(&mstp_Bridge.pvstProtectionLports);
